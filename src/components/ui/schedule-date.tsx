...
export const ScheduleDate: React.FC<ScheduleDateProps> = ({
  ...
  return (
    <div className="mx-auto flex w-full max-w-[195px] flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-white font-sans text-neutral-600 shadow-2xl dark:border-neutral-800 dark:bg-black dark:text-neutral-400" style={{ maxWidth: '100%' }}>
